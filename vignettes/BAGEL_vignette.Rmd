...
result=BAGEL::discover_signatures(input = bagel, table_name = "SNV96", 
...
BAGEL::compare_cosmic_v2(result, threshold = 0.8)
...
cosmic_post = predict_exposure(bagel = bagel, "SNV96", signatures_to_use = c(12, 4, 11, 15))
...
our_sigs_post = predict_exposure(bagel = bagel, "SNV96", signatures = result@signatures)
