...
#kidney <- MotifSig::maf_to_dt(maf_file = kidney_maf)
#dat <- kidney

#Load MAF File
lusc_maf <- system.file("testdata", "public_TCGA.LUSC.maf", package = "MotifSig") 
lusc <- MotifSig::maf_to_dt(maf_file = lusc_maf)

#Load individual VCF Files
luad1_vcf <- system.file("testdata", "public_LUAD_TCGA-97-7938.vcf", package = "MotifSig")
luad1 <- MotifSig::vcf_to_dt(vcf = luad1_vcf)
luad2_vcf <- system.file("testdata", "public_LUAD_TCGA-MP-A4TJ.vcf", package = "MotifSig")
luad2 <- MotifSig::vcf_to_dt(vcf = luad2_vcf)

#Load Multiple VCF Files At Once
melanoma_vcf <- list.files(system.file("testdata", package = "MotifSig"), pattern = glob2rx("*SKCM*vcf"), 
           full.names = TRUE)
...
#saveRDS(dat, "/Users/atgc/Documents/Aaron_Tools/MotifSig/MotifSig/inst/testdata/dt.rds")
#readRDS(system.file("testdata", "dt.rds", package = "MotifSig"))
...
#Load VCF Files
#vcfs <- list.files(system.file("testdata", package = "MotifSig"), "*.vcf", full.names = TRUE)
...
#saveRDS(bagel, "/Users/atgc/Documents/Aaron_Tools/MotifSig/MotifSig/inst/testdata/bagel.rds")
#readRDS(system.file("testdata", "bagel.rds", package = "MotifSig"))
...
#saveRDS(result, "/Users/atgc/Documents/Aaron_Tools/MotifSig/MotifSig/inst/testdata/res.rds")
#readRDS(system.file("testdata", "res.rds", package = "MotifSig"))
...
MotifSig::what_cosmic30_sigs("lung")
