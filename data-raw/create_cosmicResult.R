...
cosmic_v3_snv_sigs_exome <- new("Result", signatures = as.matrix(exome_mat), type = "Cosmic_v3_SNV_Exome")
usethis::use_data(cosmic_v3_snv_sigs_exome, internal = TRUE)
...
cosmic_v3_snv_sigs <- new("Result", signatures = as.matrix(snv_mat), type = "Cosmic_v3_SNV_Genome")
usethis::use_data(cosmic_v3_snv_sigs, internal = TRUE)
