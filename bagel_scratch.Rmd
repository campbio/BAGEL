...
BAGEL:::create_variant_table(a, "Transcribed_Strand", "transcribed_strand")
...
subset_
res = find_signatures(a, "transcribed_strand", 3, "nmf")
plot_signatures(res)
...
annotate_transcript_strand <- function(bay, genome_build, build_table = TRUE) {
  ...
  if (build_table) {
    ...
    tab <- create_variant_table(dat_bagel, variant_annotation = Transcribed_Strand,
